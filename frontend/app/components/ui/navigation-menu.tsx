...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root
      ...
      className={cn(
        'group/navigation-menu relative flex h-[50px] max-w-max flex-1 items-center justify-center rounded-md border border-strong p-1',
        className,
      )}
      {...props}
    >
  ...
  return (
    <div className={cn('absolute left-0 top-full isolate z-50 flex justify-center')}>
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          'relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full origin-top overflow-hidden rounded-md border border-strong bg-popover text-popover-foreground shadow-md md:w-[var(--radix-navigation-menu-viewport-width)]',
...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "flex flex-col gap-1 rounded-md px-4 py-2 text-button outline-none [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-foreground-muted",
        'transition-[color,background-color,box-shadow] duration-fast ease-standard',
        'hover:bg-accent hover:text-accent-foreground active:bg-accent-active',
        'focus-visible:ring-2 focus-visible:ring-ring-focus focus-visible:ring-offset-2 focus-visible:ring-offset-background',
