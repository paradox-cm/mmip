  ...
  return (
    <>
      ...
      <DocSection
        ...
        description="This 1200 × 630 image is the live Open Graph card for iMessage, Slack, Facebook, LinkedIn, and X. It uses Helvetica Now Medium for the title, Helvetica Now for supporting copy, warm sand surfaces, brand ink, and a gold accent."
      >
        <Preview label="/og.png">
          <Image
            src="/og.png"
            width={1200}
            height={630}
        ...
        <p className="max-w-reading text-sm text-foreground-subtle">
          Pages share this generated brand card. CMS Open Graph uploads are not used for social
          previews. The public URL is <DocCode>/og.png</DocCode>, served from the same generator as{' '}
          <DocCode>/opengraph-image</DocCode>.
        </p>
      </DocSection>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="px-4 py-3 text-foreground-subtle">
                  1200 × 630 PNG used by iMessage and other link previews
                </td>
                <td className="px-4 py-3 text-right">
                  <Link
                    className="focus-ring rounded-sm text-primary hover:underline"
